...
<!-- НАПРАВЛЕНИЯ РАЗРАБОТКИ (перелинковка) -->
<section class="related-services">
    <div class="container">
        <div class="section-header">
            <h2>Направления разработки приложений</h2>
            <p>Выберите профильное решение — под каждую задачу у нас отдельная экспертиза</p>
        </div>
        <div class="related-grid">
            <a href="https://mdlab.kz/razrabotka-prilozheniya-dlya-ios" class="related-link"><i class="fa-brands fa-apple"></i> Приложения для iOS</a>
            <a href="https://mdlab.kz/razrabotka-prilozheniya-dlya-android" class="related-link"><i class="fa-brands fa-android"></i> Приложения для Android</a>
            <a href="https://mdlab.kz/krossplatformennaya-razrabotka" class="related-link"><i class="fa-solid fa-mobile-screen-button"></i> Кроссплатформенная разработка</a>
            <a href="https://mdlab.kz/razrabotka-mvp-prilozheniya" class="related-link"><i class="fa-solid fa-rocket"></i> Разработка MVP</a>
            <a href="https://mdlab.kz/razrabotka-prilozheniya-internet-magazina" class="related-link"><i class="fa-solid fa-cart-shopping"></i> Для интернет-магазина</a>
            <a href="https://mdlab.kz/razrabotka-prilozheniya-dlya-dostavki" class="related-link"><i class="fa-solid fa-truck-fast"></i> Для доставки еды</a>
            <a href="https://mdlab.kz/razrabotka-prilozheniya-dlya-taksi" class="related-link"><i class="fa-solid fa-taxi"></i> Для такси</a>
            <a href="https://mdlab.kz/razrabotka-prilozheniya-dlya-biznesa" class="related-link"><i class="fa-solid fa-building"></i> Корпоративные (для бизнеса)</a>
            <a href="https://mdlab.kz/razrabotka-prilozheniya-dlya-fitnesa" class="related-link"><i class="fa-solid fa-dumbbell"></i> Для фитнеса и спорта</a>
            <a href="https://mdlab.kz/razrabotka-prilozheniya-dlya-restorana" class="related-link"><i class="fa-solid fa-utensils"></i> Для ресторана и кафе</a>
            <a href="https://mdlab.kz/razrabotka-prilozheniya-s-oplatoy" class="related-link"><i class="fa-solid fa-credit-card"></i> С онлайн-оплатой</a>
        </div>
    </div>
</section>
